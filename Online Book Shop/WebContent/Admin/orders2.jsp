...
if (request.getParameter("did") != null) {
    ...
    String message = "Dear " + userName + ",\n\nYour order #" + did + " has been cancelled successfully.\n\nThank you.";
    SendMail.send(userEmail, subject, message);

    successMsg = "Order is cancelled successfully...";
    redirectUrlSuccess = "/Online_Book_Shop/Admin/orders2.jsp";
}
...
if (request.getParameter("oid") != null) {
    ...
    // Send email notification
    String subject = "Order Dispatched - #" + oid;
    String message = "Dear " + userName + ",\n\n"
                   + "Your order #" + oid + " has been dispatched.\n\n"
