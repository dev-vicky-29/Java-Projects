...
if(request.getParameter("did")!=null){
	...
	redirectUrlSuccess="/Online_Book_Shop/Customer/orderhistory.jsp";
}
%>
...
<td>
<a href="/Online_Book_Shop/Customer/orderinfo.jsp?oid=<%=rs.getString(1) %>"  class="btn btn-danger">Details</a>
<%
