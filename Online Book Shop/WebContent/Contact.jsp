...
if (request.getParameter("btnSubmit") != null) {
    ...
    String message = request.getParameter("message");
            ...
            db.executeSql("INSERT INTO contacts (name, email, message) VALUES (?, ?, ?)", name, email, message);
                ...
                redirectUrlSuccess = "/Online_Book_Shop/Contact.jsp";
            }
%>
    ...
    <div class="container">
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-6">
                ...
                <p><strong>Address:</strong> Online Book Shop, India <br>Pin-110 001</p>
                <p><strong>Phone:</strong> +91 9876543210</p>
                <p><strong>Email:</strong> onlinebookshop@example.com</p>
            </div>
