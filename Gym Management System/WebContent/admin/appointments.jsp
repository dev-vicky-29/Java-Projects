...
if(request.getParameter("b1")!=null){
	...
	sql="select * from appointment where Status='"+selst+"'";
}
	...
	Mail.send(eid,"Your appointment request", "Your appointment Accepted.Please visit us tommorow");
	db.execute("Update appointment set Status=? where AppointmentId=? ", st,id);
...
<a class="btn btn-primary hidden-print" href="home.jsp">Back</a>
<br>
...
<table id="table1" class="table table-bordered">
  ...
  <tr>
		...
		<%
		String sts=rs.getString(8);
		
		if(sts.equals("Pending"))
		{
			%>
			<td><a href="?id=<%=rs.getString(1)%>&act=Accepted&eid=<%=rs.getString(7)%>"  class="btn btn-success" >Accept</a>
			<%
