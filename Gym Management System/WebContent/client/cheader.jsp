...
<html lang="en">
  ...
  <body>
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand py-2 px-4" href="client.jsp">Muscle</a>
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	        <span class="oi oi-menu"></span> Menu
	      </button>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="client.jsp" class="nav-link">Home</a></li>
	          <li class="nav-item"><a href="profile.jsp" class="nav-link">Update Profile</a></li>
	          	          <li class="nav-item"><a href="measurment.jsp" class="nav-link">measurments</a></li>
