...
if(request.getParameter("eid")!=null){
    ...
    response.sendRedirect("/Online_Furniture_Shop/Admin/edit_product.jsp"); // Redirect to edit product page
}
%>
            ...
            <table id="table1" class="table border-primary border border-5">
                ...
                %>
                    <tr>
                        ...
                        <td><div><img alt="Product Image" class="img-fluid" style="max-width: 100px;" src="/Online_Furniture_Shop/ProductImages/<%= rs.getString(12) %>"></div></td>
                        ...
                        <td class=" d-flex justify-content-between">
                            <form action="/Online_Furniture_Shop/Admin/edit_product.jsp" method="post">
