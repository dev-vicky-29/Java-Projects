...
<div class="container-fluid pt-2">
    <div class="container">
        <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
            ...
            <h1 class="display-4 text-uppercase">Furniture Deals</h1>
        </div>
        <div class="row gx-5">
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="card h-100 border-primary">
                    <img class="card-img-top" src="/Online_Furniture_Shop/img/furniture1.jpg" alt="Furniture 1">
                    <div class="card-body d-flex flex-column">
                        <h4 class="card-title text-uppercase mb-2">Modern Sofa</h4>
                        <p class="card-text">Elevate your living room with this stylish sofa at a special price!</p>
                        <p class="card-text"><strong>Discount:</strong> 10%</p>
                        <p class="card-text"><strong>Price:</strong> <del>$1000</del> - $900</p>
                        <a href="#" class="btn btn-primary mt-auto">Buy Now</a>
                    </div>
                </div>
            </div>
            <!-- Add more furniture items here following the same structure -->
        </div>
    </div>
</div>
<!-- Offers End -->
