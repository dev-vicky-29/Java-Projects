...
if(request.getParameter("did")!=null){
	...
	redirectUrlSuccess="/Online_Furniture_Shop/Customer/orderhistory.jsp";
}
%>
...
<td>
<a href="/Online_Furniture_Shop/Customer/orderinfo.jsp?oid=<%=rs.getString(1) %>"  class="btn btn-danger">Details</a>
<%
