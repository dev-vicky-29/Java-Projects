    ...
    <div class="container">
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-6">
                ...
                <p><strong>Address:</strong> Furniture Shop, Karad <br>       Pin-415 512</p>
                <p><strong>Phone:</strong> +91 7276942909</p>
                <p><strong>Email:</strong> onlinefurnitureshop29@gmail.com</p>
            </div>
            <!-- Contact Form -->
...
if (request.getParameter("btnSubmit") != null) {
    ...
    db.executeSql("INSERT INTO contacts (name, email, message) VALUES (?, ?, ?)", name, email, message);
        ...
        redirectUrlSuccess="/Online_Furniture_Shop/Contact.jsp";
