    ...
    <form method="post" id="form1" class="form custom-border mt-8 rounded">
        <div class="col-6 offset-3">
            ...
            <div class="text-center mt-3">
                <a class="text-center text-decoration-none" style="color: black;" href="/Online_Blood_Bank_Management_System/forgotpassword.jsp">Forgot Password?</a>
            </div> 
            <hr/>
            <!-- Login Link -->
                    <div class="text-center">
                        <p>New Member? <a href="/Online_Blood_Bank_Management_System/signup.jsp">Sign Up here</a></p>
                    </div>
