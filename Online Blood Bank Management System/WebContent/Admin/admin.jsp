...
<div class="hero-section text-center text-dark" >
    <h1 class="display-3">Online Blood Bank Management System</h1>
...
<div class="container pt-5">
    <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 800px;">
        ...
        <h1 class="display-6 text-uppercase">Welcome to the Online Blood Donation Management System</h1>
    </div>
    <div class="row gx-5">
        ...
        <div class="col-lg-6 pb-5">
            <h4 class="mb-4">We are committed to facilitating blood donation and management with efficiency and transparency.</h4>
            <p class="mb-5">Our Online Blood Donation Management System connects blood donors with those in need, providing a streamlined platform for donation, inventory management, and information sharing. Our mission is to make blood donation accessible and reliable to save lives every day.</p>
            <div class="row g-5">
                <div class="col-sm-6">
