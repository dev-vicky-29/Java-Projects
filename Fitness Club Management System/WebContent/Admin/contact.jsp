...
<div class="text-center mt-5">
            ...
            <a href="/Fitness_Club_Management_System/Admin/ContactList.jsp" class="btn btn-danger btn-lg mt-3">Contact List</a>
        </div>
    ...
    <div class="container">
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-6">
                ...
                <p><strong>Address:</strong> Fitness Club, Karad <br>       Pin-415 512</p>
                <p><strong>Phone:</strong> +91 7276942909</p>
                <p><strong>Email:</strong> onlinefitnessclub29@gmail.com</p>
            </div>
            <!-- Contact Form -->
...
if (request.getParameter("btnSubmit") != null) {
    ...
    db.executeSql("INSERT INTO contacts (name, email, message) VALUES (?, ?, ?)", name, email, message);
        ...
        redirectUrlSuccess="/Fitness_Club_Management_System/contact.jsp";
