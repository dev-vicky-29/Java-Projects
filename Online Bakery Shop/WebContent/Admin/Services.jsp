    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-12 col-md-5 text-center">
                ...
                <a href="/Online_Bakery_Shop/signup.jsp" class="btn btn-info border-inner py-3 px-5">Order Now</a> <hr>
            </div>
        </div>
    </div>
</div>
...
<h3 class="text-uppercase text-primary mb-2">FeedBack Section</h3><hr>
 <a href="/Online_Bakery_Shop/Admin/feedbacklist.jsp" class="btn btn-info border-inner py-3 px-5">FeedBack List</a><br> <hr>
 </div>
