...
if(request.getParameter("btnsignup")!=null){
    ...
    try {
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/bakerydb", "root", "VICK2909");
    ...
    if (idExists) {
        ...
        try {
            ...
            if(rowsAffected > 0) {
                ...
                successMsg=name+" You are successfully Created Account on Bakery Palace! Please Login Now..!";
                // Redirect to another page to prevent resubmission
                redirectUrlSuccess="/Online_Bakery_Shop/login.jsp";
            } else {
                // Registration failed
    ...
    <form method="post" id="form1" class="form custom-border mt-8 rounded">
        <div class="col-6 offset-3">
            ...
            <div class="form-group">
                ...
                <div id="id-error" class="invalid-feedback"></div> <!-- Container for error message -->
            </div><br>
            <div class="form-group">
                Full Name<br>
            ...
            <div class="text-center d-grid gap-2">
                <input type="submit" name="btnsignup" value="Sign Up" class="btn btn-lg btn-primary"/>
            </div>
            <hr>
            <div class="text-center mt-3">
                <span>Already have an account? </span><a class="text-center text-decoration-none" style="color: black;" href="/Online_Bakery_Shop/login.jsp">Login</a>
            </div> 
        </div>
    </form>
</div>
