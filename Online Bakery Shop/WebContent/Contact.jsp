    ...
    <div class="container">
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-6">
                ...
                <p><strong>Address:</strong> Bakery Palace, Karad <br>       Pin-415 109</p>
                <p><strong>Phone:</strong> +91 7276942909</p>
                <p><strong>Email:</strong> bakerypalace29@gmail.com</p>
            </div>
            <!-- Contact Form -->
...
if (request.getParameter("btnSubmit") != null) {
    ...
    db.executeSql("INSERT INTO contacts (name, email, message) VALUES (?, ?, ?)", name, email, message);
        ...
        redirectUrlSuccess="/Online_Bakery_Shop/Contact.jsp";
