...
if(request.getParameter("btnlogin")!=null){
	...
	if(user.equals("Admin")){
		...
		if(rs.next()){
			...
			response.sendRedirect("/Online_Bakery_Shop/Admin/admin.jsp");
		} else{
			...
			redirectUrlError="/Online_Bakery_Shop/login.jsp";
		}
		...
		if(rs.next()){
			...
			response.sendRedirect("/Online_Bakery_Shop/Customer/customer.jsp");
		} else {
			session.setAttribute("user", null);
			session.setAttribute("mail", null);
			session.setAttribute("pass", null);
    ...
    <form method="post" id="form1" class="form custom-border mt-8 rounded">
        <div class="col-6 offset-3">
            ...
            <div class="text-center mt-3">
                <a class="text-center text-decoration-none" style="color: black;" href="/Online_Bakery_Shop/forgotpassword.jsp">Forgot Password?</a>
            </div> 
            <hr/>  -->
