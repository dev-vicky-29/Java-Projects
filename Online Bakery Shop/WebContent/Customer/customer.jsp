...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="/Online_Bakery_Shop/img/hero1.jpg" class="d-block w-100 carousel-img" alt="Bakery Image">
        </div>
        <div class="carousel-item">
            <img src="/Online_Bakery_Shop/img/hero.jpg" class="d-block w-100 carousel-img" alt="Bakery Image">
        </div>
         <div class="carousel-item">
            <img src="/Online_Bakery_Shop/img/hero4.jpg" class="d-block w-100 carousel-img" alt="Bakery Image">
        </div>
        <div class="carousel-item">
            <img src="/Online_Bakery_Shop/img/hero3.jpg" class="d-block w-100 carousel-img" alt="Bakery Image">
        </div>
    </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="bg-info border-inner text-center text-white d-flex flex-column justify-content-between p-5 service-card" style="height: 100%;">
                    ...
                    <a class="text-uppercase text-white" href="/Online_Bakery_Shop/Customer/BookCake.jsp">Order Now <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-6 text-center">
                ...
                <a href="/Online_Bakery_Shop/BookCake.jsp" class="btn btn-info border-inner py-3 px-5">Order Now</a><br> <hr>
            </div>
        </div>
    </div>
</div>
