        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-4">
                <div class="bg-warning border-inner text-center text-dark d-flex flex-column justify-content-between p-5 service-card">
                    ...
                    <a class="text-uppercase text-dark" href="/Zara_Fashion/Customer/Products.jsp">Shop Now <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-4">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="bg-info text-center text-white d-flex flex-column justify-content-between p-5 service-card">
                    ...
                    <a class="text-uppercase text-white" href="/Zara_Fashion/Customer/Contact.jsp">Contact Us <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
