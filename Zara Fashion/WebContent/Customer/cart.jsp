...
if(request.getParameter("cid")!=null){
	...
	response.sendRedirect("/Zara_Fashion/Customer/cart.jsp");
}
...
<table id="tb" class="table table-bordered">
	...
	<tr>
		...
		<td>
		<img src="/Zara_Fashion/ProductImages/<%=rs.getString(7) %>" width="100" height="100" alt="NA" class="rounded"/>
		</td>		
...
<a href="genorder.jsp" class="btn btn-dark">Generate Order</a>
</div>
