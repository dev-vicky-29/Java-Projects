...
if(request.getParameter("btnlogin")!=null){
	...
	if(user.equals("Admin")){
		...
		if(rs.next()){
			...
			response.sendRedirect("/Zara_Fashion/Admin/admin.jsp");
		} else{
			...
			redirectUrlError="/Zara_Fashion/login.jsp";
		}
		...
		if(rs.next()){
			...
			response.sendRedirect("/Zara_Fashion/Customer/customer.jsp");
		} else {
			session.setAttribute("user", null);
			session.setAttribute("mail", null);
			session.setAttribute("pass", null);
    ...
    <form method="post" id="form1" class="form custom-border mt-8 rounded">
        <div class="col-6 offset-3">
            ...
            <div class="text-center d-grid gap-2">
                <input type="submit" name="btnlogin" value="Login" class="btn btn-lg btn-dark" />
            </div>
            <hr>
            <!-- 
            <div class="text-center mt-3">
                <a class="text-center text-decoration-none" style="color: black;" href="/Zara_Fashion/forgotpassword.jsp">Forgot Password?</a>
            </div> 
            <hr/>  -->
