...
<%
    if(request.getParameter("btnsignup") != null) {
        ...
        String parentContact = request.getParameter("txtparentcontact");
        String gender = request.getParameter("gender");
        String studentClass = request.getParameter("txtCourse");
        String password = request.getParameter("txtpass");
        
        // Insert student details with pending status
        int result = db.executeSql("INSERT INTO student (Name, EmailID, Contact, ParentContact, Gender, Class, Password, Status) VALUES (?, ?, ?, ?, ?, ?, ?, 'Pending')", name, email, contact, parentContact, gender, studentClass, password);
...
<div class="container">
    <form method="post" class="form mt-8">
        <div class="col-6 offset-3">
            ...
            <div class="form-group">
                <label>Contact</label>
                <input type="text" id="contact" name="txtcontact" class="form-control" required>
            </div>
            
            <div class="form-group">
                <label>Parent Contact</label>
                <div class="input-group">
                    <input type="text" id="parentContact" name="txtparentcontact" class="form-control" required>
                    <button type="button" onclick="copyContact()" class="btn btn-secondary">Same as Contact</button>
                </div>
            </div>
...
<script>
    function copyContact() {
        document.getElementById("parentContact").value = document.getElementById("contact").value;
    }
</script>
