...
<%
    ...
    ResultSet newsResult = db.getRows("SELECT * FROM news WHERE status = 'Active' ORDER BY created_at DESC");
%>
...
<div class="container">
        ...
        <div class="marquee-content">
            <% 
                while (newsResult.next()) { 
                    String title = newsResult.getString("news_title");
    ...
    <div class="news-container">
        ...
        %>
            <div class="news-card">
                <h5><%= newsResult.getString("news_title") %></h5>
                ...
                <% if (newsResult.getString("link") != null && !newsResult.getString("link").isEmpty()) { %>
                    <a href="<%= newsResult.getString("link") %>" target="_blank" class="news-link"> Read More</a>
                <% } %>
            </div>
        <% } %>
    </div>
