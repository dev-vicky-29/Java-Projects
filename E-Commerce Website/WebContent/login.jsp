...
if(request.getParameter("btnlogin")!=null){
	...
	if(user.equals("Admin")){
		...
		if(rs.next()){
			...
			response.sendRedirect("/E-Commerce_Website/Admin/admin.jsp");
		} else{
			...
			redirectUrlError="/E-Commerce_Website/login.jsp";
		}
		...
		if(rs.next()){
			...
			response.sendRedirect("/E-Commerce_Website/Customer/customer.jsp");
		} else {
			session.setAttribute("user", null);
			session.setAttribute("mail", null);
			session.setAttribute("pass", null);
    ...
    <form method="post" id="form1" class="form custom-border mt-8 rounded">
        <div class="col-6 offset-3">
            ...
            <div class="text-center border p-3 hover-effect mt-3">
                ...
                <a href="/E-Commerce_Website/signup.jsp" class="d-inline" style="font-weight: bold;">Sign Up</a>
            </div>
        </div>
    </form>
</div>
