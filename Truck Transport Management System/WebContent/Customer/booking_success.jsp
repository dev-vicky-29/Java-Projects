        ...
        try {
            ...
            if (rs.next()) {
                details = "<p><strong>Booking ID:</strong> " + rs.getInt("id") + "</p>" +
                          ...
                          "<p><strong>DriverID:</strong> " + rs.getString("driver_id") + "</p>"; // New field
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="text-center mt-4">
                ...
                <a href="/Truck_Transport_Management_System/Customer/BookTruck.jsp" class="btn btn-primary">Book Another Truck</a>
            </div>
        </div>
    </div>
</div>
