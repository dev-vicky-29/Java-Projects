...
<div class="hero-section text-center text-dark">
    ...
    <a href="/Truck_Transport_Management_System/signup.jsp" class="btn btn-primary btn-lg">Register as Client</a>
    <a href="/Truck_Transport_Management_System/request_truck.jsp" class="btn btn-outline-dark btn-lg">Request a Truck</a>
</div>
<!-- Hero Section End -->
