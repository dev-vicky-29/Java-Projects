...
<header class="bg-light text-white text-center py-5">
        <div class="container">
            ...
            <a href="/Staff_Pro_Management_System/Staff/dashboard.jsp" class="btn btn-light btn-lg">Dashboard</a>
            <a href="/Staff_Pro_Management_System/Staff/Attendance.jsp" class="btn btn-outline-dark btn-lg">Attendance</a>
        </div>
    </header>
