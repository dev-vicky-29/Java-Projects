    ...
    <div class="container">
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-6">
                ...
                <p><strong>Name:</strong> Staff Pro Management System</p>
                <p><strong>Phone:</strong>+91 7276942909</p>
                <p><strong>Email:</strong>staffprok@gmail.com</p>
            </div>
            <!-- Contact Form -->
...
if (request.getParameter("btncontact") != null) {
    ...
    String message = request.getParameter("message");
        ...
        response.sendRedirect("/Staff_Pro_Management_System/contact.jsp");
}
...
<!-- Contact Form -->
            <div class="col-lg-6">
                ...
                <input Type="submit" value="Submit" name="btncontact" class="btn btn-lg btn-primary"/>
            </div>
                    </form>
                </div>
            </div>
