...
<div class="tab-pane fade show active" id="men" role="tabpanel">
		...
		<br>
                <h1 class="text-uppercase text-primary mb-4">Admin You Can't Order This Product this is for Only Your Customer</h1>  <hr>
               <div class="d-flex justify-content-around mb-4">
                <a href="/Online_Cloth_Shop/Admin/AddProduct.jsp" class="btn btn-info">Add Product</a>
                <a href="/Online_Cloth_Shop/Admin/ProductList.jsp" class="btn btn-info">View Product List</a>
            </div>
            <hr><br>
            </div>
...
<%
 ...
 %>
  ...
  <div class="col-lg-12 col-md-6 text-center">
                <h1 class="text-uppercase text-primary mb-4">Admin You Can't Order This Product this is for Only Your Customer</h1>  <hr>
                <a href="/Online_Cloth_Shop/Admin/AddProduct.jsp" class="btn btn-info border-inner py-3 px-5">Add Product</a><br> <hr>
                <a href="/Online_Cloth_Shop/Admin/ProductList.jsp" class="btn btn-info border-inner py-3 px-5">View Product List</a><hr><br>
            </div>
    <div class="row row-cols-1 row-cols-md-3 g-4">
