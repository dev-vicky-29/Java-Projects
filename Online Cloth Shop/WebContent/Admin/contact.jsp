...
<div class="col-lg-12 col-md-6 pt-5 text-center">
                ...
                <a href="/Online_Cloth_Shop/Admin/ContactList.jsp" class="btn btn-info border-inner py-3 px-5">See Here</a><br> <hr>
                 </div>
    ...
    <div class="container">
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-6">
                ...
                <p><strong>Address:</strong> Shree Collection, Near Bus Stand Karad-Masur Road, Masur pin-415 106 </p>
                <p><strong>Phone:</strong> +91 7040334491</p>
                <p><strong>Email:</strong> shreecollection6060@gmail.com</p>
            </div>
            <!-- Contact Form -->
