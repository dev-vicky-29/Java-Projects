 				...
 				if(mrequest.getParameter("ntbtnadd")!=null){
 					...
 					if(ht!=null && ht.size()>0){
 						UploadFile uf=(UploadFile)ht.get("productImage"); //Return Type ==> Object
 								...
 								db.executeSql("insert into offers ( ProductName, CategoryName, Size, MPrice, OPrice, Qty, ProductImage)  values (?,?,?,?,?,?,?)", pName, cName,pSize,mPrice,oPrice,pQty, pImgName); //This Line For Insert Record Into Database Product table	
...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h2 class="mb-4">Add Offer Product</h2>
            <form  method="post" enctype="multipart/form-data">
                ...
                <button type="submit" name="ntbtnadd" class="btn btn-primary">Add Offer</button>
                </div>
            </form>
        </div>
    </div>
