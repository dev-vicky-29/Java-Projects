...
<div class="container-fluid pt-5">
    <div class="container">
        <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
            ...
            <h1 class="display-4 text-uppercase">Special Offers</h1>
        </div>
        <div class="row gx-5">
          <%
  ...
  %>
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="card h-100 border-primary">
                    ...
                    <img class="card-img-top" src="/Online_Cloth_Shop/ProductImages/<%= rs.getString(8) %>" alt="T-Shirt 1">
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text"><strong>Price:</strong> <del>Rs.<%= rs.getString(5) %></del> - Rs. <%= rs.getString(6) %></p>
