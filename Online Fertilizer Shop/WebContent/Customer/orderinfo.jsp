...
<td>
<img src="/Online_Fertilizer_Shop/ProductImages/<%=rs.getString(9) %>" width="70" height="70" alt="NA"/>
</td>
</tr>
<%
...
<div class="alert alert-dismissible alert-warning w-75 offset-1">
  ...
  <p class="mb-0">Order Id <%=oid%> is not exists. <a href="/Online_Fertilizer_Shop/Customer/Customer.jsp" class="alert-link">Back to Home</a>.</p>
</div>
<%	
}
}else{
...
<div class="alert alert-dismissible alert-warning  w-75 offset-1">
  <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
  <h4 class="alert-heading">Warning!</h4>
  <p class="mb-0">Please provide order id. <a href="/Online_Fertilizer_Shop/Customer/customer.jsp" class="alert-link">Back to Home</a>.</p>
</div>
<%
}
%>
