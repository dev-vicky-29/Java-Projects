    ...
    <div class="container">
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-6">
                ...
                <p><strong>Address:</strong> Fertilizer Market, Karad <br> Pin-415 110</p>
                <p><strong>Phone:</strong> +91 9876543210</p>
                <p><strong>Email:</strong> fertilizer.shop@example.com</p>
            </div>
            <!-- Contact Form -->
...
if (request.getParameter("btnSubmit") != null) {
    ...
    redirectUrlSuccess="/Online_Fertilizer_Shop/Customer/contact.jsp";
}
%>
