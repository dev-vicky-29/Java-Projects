...
if(request.getParameter("did")!=null){
	...
	redirectUrlSuccess="/Online_Fertilizer_Shop/Customer/orderhistory.jsp";
}
%>
...
<td>
<a href="/Online_Fertilizer_Shop/Customer/orderinfo.jsp?oid=<%=rs.getString(1) %>"  class="btn btn-danger">Details</a>
<%
