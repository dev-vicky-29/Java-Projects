...
<div id="myTabContent" class="tab-content">
  ...
  <div class="tab-pane fade show active" id="organic" role="tabpanel">
    <div class="row row-cols-1 row-cols-md-3 g-4">
      ...
      ResultSet rs = db.getRows("SELECT * FROM Product WHERE Status='Active'");  // Only showing active products
      while (rs.next()) {
      %>
      <div class="col">
        <div class="card h-100 mb-3">
          ...
          <div class="card-body d-flex flex-column">
            ...
            <div class="mt-auto">
              <a href="/Online_Fertilizer_Shop/login.jsp" class="btn btn-primary w-100">Buy Now</a>
            </div>
          </div>
        </div>
      </div>
