<%@ include file="header.jsp"%>
 ...
 <hr>
 <br>
 <h1 class="text-center bg-warning text-dark">Cake Delight Products</h1>
<br>
<hr>
<br> 
 </div>
...
<div class="row row-cols-1 row-cols-md-3 g-4">
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="/Online_Cake_Shop/ProductImages/<%= rs.getString(9) %>" class="img-fluid rounded-start h-auto" alt="Product Images">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title fw-bold"><%= rs.getString(2) %></h5>
        <p class="card-text text-success "> Category Name: <%= rs.getString(3) %></p>
        ...
        <a href="/Online_Cake_Shop/login.jsp" class="btn  btn-primary">Buy Now</a>
        </div>
      </div>
    </div>
  </div>
