...
if(request.getParameter("cid")!=null){
	...
	response.sendRedirect("/Online_Cake_Shop/Customer/cart.jsp");
}
...
<table id="tb" class="table table-bordered">
	...
	<tr>
		...
		<td>
		<img src="/Online_Cake_Shop/ProductImages/<%=rs.getString(7) %>" width="100" height="100" alt="NA" class="rounded"/>
		</td>		
