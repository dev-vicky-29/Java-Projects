        ...
        <div class="row gx-5">
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="card h-100 border-primary">
                    <img class="card-img-top" src="/Online_Cake_Shop/img/cake1.jpg" alt="Cake 1">
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="/Online_Cake_Shop/Customer/BookCake.jsp" class="btn btn-primary mt-auto">Order Now</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="card h-100 border-primary">
                    <img class="card-img-top" src="/Online_Cake_Shop/img/cake2.jpg" alt="Cake 2">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="card h-100 border-primary">
                    <img class="card-img-top" src="/Online_Cake_Shop/img/cake3.jpg" alt="Cake 3">
                    <div class="card-body d-flex flex-column">
