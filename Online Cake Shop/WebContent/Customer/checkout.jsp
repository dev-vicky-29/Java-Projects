...
if(request.getParameter("btn1")!=null){
	...
	if(s.equals("COD")){
		...
		response.sendRedirect("/Online_Cake_Shop/Customer/checkout1.jsp");
...
<div class="col">
<img src="/Online_Cake_Shop/img/payment/paypal.png" alt="NA" width="80%" height="70%"/>
</div>
<div class="col">
<img src="/Online_Cake_Shop/img/payment/mastercard.png" alt="NA"  width="80%" height="70%"/>
</div>
<div class="col">
<img src="/Online_Cake_Shop/img/payment/visacard.jpeg" alt="NA" width="80%" height="70%"/>
</div>
<div class="col">
<img src="/Online_Cake_Shop/img/payment/gpay.png" alt="NA" width="80%" height="70%"/>
</div>
<div class="col">
<img src="/Online_Cake_Shop/img/payment/phonepe.png" alt="NA" width="80%" height="70%"/>
</div>
</div>
