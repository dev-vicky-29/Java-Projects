...
if(request.getParameter("did")!=null){
	...
	redirectUrlSuccess="/Online_Cake_Shop/Customer/orderhistory.jsp";
}
%>
...
<td>
<a href="/Online_Cake_Shop/Customer/orderinfo.jsp?oid=<%=rs.getString(1) %>"  class="btn btn-danger">Details</a>
<%
